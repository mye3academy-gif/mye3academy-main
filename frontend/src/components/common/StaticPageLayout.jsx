...
const StaticPageLayout = ({ title, subtitle, children }) => {
  return (
    <div className="bg-slate-50 min-h-screen">
      {/* HEADER SECTION */}
      <div className="bg-slate-900 border-b border-white/5 pt-28 pb-16">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 pb-20">
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8 md:p-12 prose prose-slate max-w-none prose-headings:font-black prose-p:leading-relaxed prose-li:font-medium">
          {children}
        </div>
      </div>
    </div>
