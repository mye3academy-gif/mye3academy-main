    ...
    >
      <div className="grid md:grid-cols-2 gap-16">
        ...
        <div className="space-y-10">
          <div>
            <h2 className="text-2xl font-black text-slate-800 mb-6 uppercase tracking-tight">Get in Touch</h2>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-black text-slate-800 uppercase text-[10px] tracking-widest mb-1">Email Us</h4>
                <p className="text-slate-600 font-bold">support@mye3academy.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-black text-slate-800 uppercase text-[10px] tracking-widest mb-1">Call Us</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-black text-slate-800 uppercase text-[10px] tracking-widest mb-1">Visit Us</h4>
        ...
        <div className="bg-slate-50 p-8 md:p-12 rounded-[2.5rem] border border-slate-100">
          <h2 className="text-2xl font-black text-slate-800 mb-8 tracking-tight">Send a Message</h2>
